...
class Printer
{
    ...
    {
        if (!isset($array['italic'])) {
            $array['italic'] = false;
        }
        if (!isset($array['underline'])) {
            $array['underline'] = false;
        }
        if (!isset($array['strikeout'])) {
            $array['strikeout'] = false;
        }
        if (!isset($array['orientation'])) {
            $array['orientation'] = 0;
        }
